...
/// </para>
/// </summary>
public class GetByDateReminderEndpoint(DbContext dbContext) : Endpoint<GetRemindersByDateRequest, List<ReminderOnDateResponse>>
{
    ...
    public override async Task HandleAsync(GetRemindersByDateRequest req, CancellationToken ct)
    {
        ...
        var oneShot = await dbContext.Set<Reminder>()
            .AsNoTracking()
        ...
        var repeating = await dbContext.Set<Reminder>()
            .AsNoTracking()
