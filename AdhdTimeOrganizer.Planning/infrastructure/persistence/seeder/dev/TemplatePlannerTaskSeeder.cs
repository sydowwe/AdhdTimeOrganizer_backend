...
namespace AdhdTimeOrganizer.Planning.infrastructure.persistence.seeder.dev;
    ...
    ILogger<TemplatePlannerTaskSeeder> logger) : IPerUserDevSeeder, IScopedService
{
    ...
    public async Task SeedForUser(long userId)
    {
        ...
        var templates = await dbContext.Set<TaskPlannerDayTemplate>()
        ...
        var importances = await dbContext.Set<TaskImportance>()
        ...
        await dbContext.Set<TemplatePlannerTask>().AddRangeAsync(templateTasks);
