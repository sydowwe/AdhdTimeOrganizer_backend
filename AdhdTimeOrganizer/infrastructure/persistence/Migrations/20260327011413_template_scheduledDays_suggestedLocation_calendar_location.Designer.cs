...
namespace AdhdTimeOrganizer.infrastructure.persistence.Migrations
{
    ...
    [Migration("20260327011413_template_scheduledDays_suggestedLocation_calendar_location")]
    partial class template_scheduledDays_suggestedLocation_calendar_location
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AdhdTimeOrganizer.domain.model.entity.activityPlanning.PlannerTask", b =>
                {
                    ...
                    b.HasIndex("TodolistId")
                        .HasDatabaseName("ix_planner_task_todolist_id");
            ...
            modelBuilder.Entity("AdhdTimeOrganizer.domain.model.entity.activityPlanning.PlannerTask", b =>
                {
                    ...
                    b.HasOne("AdhdTimeOrganizer.domain.model.entity.todoList.TodoList", "Todolist")
                        ...
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_planner_task_todo_lists_todolist_id");
