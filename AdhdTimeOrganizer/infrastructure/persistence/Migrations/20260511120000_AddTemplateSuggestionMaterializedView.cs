...
{
    /// <inheritdoc />
    public partial class AddTemplateSuggestionMaterializedView : Migration
    {
        /// <inheritdoc />
...
");
        ...
        {
            migrationBuilder.Sql("DROP MATERIALIZED VIEW IF EXISTS public.mv_template_suggestion_pattern;");
        }
    }
}
