...
namespace AdhdTimeOrganizer.infrastructure.persistence.Migrations
{
    ...
    [Migration("20260226010217_AddLastResetDateToRoutineTodoList")]
    partial class AddLastResetDateToRoutineTodoList
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AdhdTimeOrganizer.domain.model.entity.todoList.TodoList", b =>
                {
                    ...
                    b.HasIndex("TaskPriorityId")
                        .HasDatabaseName("ix_todo_list_task_priority_id");
                    ...
                    b.HasIndex("UserId", "TaskPriorityId")
                        .HasDatabaseName("ix_todo_list_user_id_task_priority_id");
            ...
            modelBuilder.Entity("AdhdTimeOrganizer.domain.model.entity.todoList.TodoList", b =>
                {
                    ...
                    b.HasOne("AdhdTimeOrganizer.domain.model.entity.todoList.TaskPriority", "TaskPriority")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_todo_list_task_priority_task_priority_id");
