...
namespace AdhdTimeOrganizer.infrastructure.persistence.Migrations
{
    ...
    [Migration("20260306005651_ActivityTrackingDesktop")]
    partial class ActivityTrackingDesktop
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdhdTimeOrganizer.domain.model.entity.activityTracking.desktop.ActivityTrackingSettingsDesktopEntryFormatting", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<bool>("IsSavedToMainHistory")
                        .HasColumnType("boolean")
                        .HasColumnName("is_saved_to_main_history");
                    ...
                    b.Property<string>("ProcessNice")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("process_nice");

                    b.Property<string>("TitleSplit")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("title_split");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_activity_tracking_settings_desktop_entry_formatting");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_activity_tracking_settings_desktop_entry_formatting_user_id");

                    b.ToTable("activity_tracking_settings_desktop_entry_formatting", "public");
                });

            modelBuilder.Entity("AdhdTimeOrganizer.domain.model.entity.activityTracking.desktop.ActivityTrackingSettingsDesktopIgnoredProcess", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("TitleContains")
                        ...
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("title_contains");

                    b.Property<bool>("TitleContainsToggle")
                        .HasColumnType("boolean")
                        .HasColumnName("title_contains_toggle");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_activity_tracking_settings_desktop_ignored_process");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_activity_tracking_settings_desktop_ignored_process_user_id");

                    b.ToTable("activity_tracking_settings_desktop_ignored_process", "public");
                });
            ...
            modelBuilder.Entity("AdhdTimeOrganizer.domain.model.entity.activityTracking.desktop.ActivityTrackingSettingsDesktopEntryFormatting", b =>
                {
                    b.HasOne("AdhdTimeOrganizer.domain.model.entity.user.User", "User")
                        .WithMany("ActivityTrackingSettingsDesktopEntryFormattingList")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_activity_tracking_settings_desktop_entry_formatting_user_us");
            ...
            modelBuilder.Entity("AdhdTimeOrganizer.domain.model.entity.activityTracking.desktop.ActivityTrackingSettingsDesktopIgnoredProcess", b =>
                {
                    b.HasOne("AdhdTimeOrganizer.domain.model.entity.user.User", "User")
                        .WithMany("ActivityTrackingSettingsDesktopIgnoredProcessList")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_activity_tracking_settings_desktop_ignored_process_user_use");
            ...
            modelBuilder.Entity("AdhdTimeOrganizer.domain.model.entity.user.User", b =>
                {
                    ...
                    b.Navigation("ActivityTrackingSettingsDesktopEntryFormattingList");

                    b.Navigation("ActivityTrackingSettingsDesktopIgnoredProcessList");
