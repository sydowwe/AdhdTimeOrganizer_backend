...
public class GetDashboardTodoListItemEndpoint(AppDbContext dbContext, TodoListItemMapper mapper) : BaseGetAllEndpoint<TodoListItem, TodoListItemResponse, TodoListItemMapper>(dbContext, mapper)
{
