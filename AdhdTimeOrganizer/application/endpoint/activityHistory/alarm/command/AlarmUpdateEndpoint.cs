...
public class AlarmUpdateEndpoint(AppCommandDbContext dbContext, AlarmMapper mapper)
    : BaseUpdateEndpoint<Alarm, AlarmRequest, AlarmResponse, AlarmMapper>(dbContext, mapper);
