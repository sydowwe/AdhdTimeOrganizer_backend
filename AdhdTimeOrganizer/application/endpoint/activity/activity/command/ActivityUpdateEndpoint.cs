...
public class ActivityUpdateEndpoint(AppCommandDbContext dbContext, ActivityMapper mapper)
    : BaseUpdateEndpoint<Activity, ActivityRequest, ActivityResponse, ActivityMapper>(dbContext, mapper);
