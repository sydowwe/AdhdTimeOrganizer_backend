...
public class CreateMemoryAnchorEndpoint(AppDbContext dbContext, MemoryAnchorMapper mapper)
    : BaseCreateEndpoint<MemoryAnchor, MemoryAnchorRequest, MemoryAnchorMapper>(dbContext, mapper)
{
