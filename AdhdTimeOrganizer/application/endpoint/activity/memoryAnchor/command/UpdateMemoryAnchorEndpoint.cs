...
public class UpdateMemoryAnchorEndpoint(AppDbContext dbContext, MemoryAnchorMapper mapper)
    : BaseUpdateEndpoint<MemoryAnchor, MemoryAnchorRequest, MemoryAnchorMapper>(dbContext, mapper)
{
