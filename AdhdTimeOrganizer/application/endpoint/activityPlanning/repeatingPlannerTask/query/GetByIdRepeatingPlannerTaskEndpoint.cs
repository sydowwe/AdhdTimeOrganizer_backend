...
public class GetByIdRepeatingPlannerTaskEndpoint(AppDbContext dbContext, RepeatingPlannerTaskMapper mapper)
    : BaseGetByIdEndpoint<RepeatingPlannerTask, RepeatingPlannerTaskResponse, RepeatingPlannerTaskMapper>(dbContext, mapper)
{
