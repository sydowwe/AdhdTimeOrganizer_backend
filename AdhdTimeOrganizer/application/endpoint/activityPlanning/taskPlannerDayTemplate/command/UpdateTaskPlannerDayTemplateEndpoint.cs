...
public class UpdateTaskPlannerDayTemplateEndpoint(AppDbContext dbContext)
    : BaseUpdateEndpoint<TaskPlannerDayTemplate, TaskPlannerDayTemplateRequest>(dbContext)
{
