...
[Mapper]
public partial class TodoListMapper : IBaseCrudMapper<TodoList, CreateTodoListRequest, UpdateTodoListRequest, TodoListResponse>
{
    ...
    public partial TodoList ToEntity(CreateTodoListRequest request, long userId);

    public partial void UpdateEntity(UpdateTodoListRequest request, TodoList entity);
