...
[Mapper]
public partial class MemoryAnchorMapper : IBaseSimpleCrudMapper<MemoryAnchor, MemoryAnchorRequest, MemoryAnchorResponse>, IBaseSelectOptionMapper<MemoryAnchor>
{
    ...
    [MapProperty(nameof(MemoryAnchor.HighlightNote), nameof(SelectOptionResponse.Text))]
    public partial SelectOptionResponse ToSelectOptionResponse(MemoryAnchor entity);
}
