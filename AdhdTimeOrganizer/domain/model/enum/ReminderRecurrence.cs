...
/// <para>
/// Deliberately a portal enum rather than a reuse of <c>Kernel.reminders.ReminderIntervalPreset</c>: the
/// Kernel enum is the scheduling contract and the portal must be free to expose a different set to users.
