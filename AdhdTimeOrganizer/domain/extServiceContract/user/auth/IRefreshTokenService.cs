...
public interface IRefreshTokenService
{
    ...
    Task<(bool IsValid, AuthMethodEnum AuthMethod, bool IsStayLoggedIn, bool IsExtensionClient, User? User, string? ErrorMessage)> ValidateRefreshTokenAsync(string refreshToken);
