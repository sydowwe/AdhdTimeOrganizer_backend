...
public class DefaultUsersSeeder(UserManager<User> userManager, DbContext dbContext, IUserDefaultsService userDefaultsService, ILogger<DefaultUsersSeeder> logger)
