...
namespace AdhdTimeOrganizer.Core.infrastructure.persistence.seeder;
...
/// </summary>
public class SeedUserIdProvider(DbContext dbContext) : ISeedUserIdProvider, ISeedUserProvider, IScopedService
{
