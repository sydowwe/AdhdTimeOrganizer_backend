...
namespace AdhdTimeOrganizer.Core.application.dto.response.timer;
...
public record PomodoroTimerPresetResponse : IdResponse, IProjectionResponse<PomodoroTimerPresetResponse, PomodoroTimerPreset>
{
    ...
    {
        return q.Select(e => new PomodoroTimerPresetResponse
        {
            Id = e.Id,
            Name = e.Name,
            ...
            FocusActivity = e.FocusActivity == null
                ? null
                : new ActivityResponse
                {
                    ...
                    Category = e.FocusActivity.Category == null
                        ? null
            ...
            RestActivity = e.RestActivity == null
                ? null
                : new ActivityResponse
                {
                    ...
                    Category = e.RestActivity.Category == null
                        ? null
                        : new ActivityCategoryResponse
                        {
