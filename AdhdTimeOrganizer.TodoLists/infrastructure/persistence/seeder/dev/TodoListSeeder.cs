...
namespace AdhdTimeOrganizer.TodoLists.infrastructure.persistence.seeder.dev;
    ...
    ILogger<TodoListItemSeeder> logger) : IScopedService, IPerUserDevSeeder
{
    ...
    public async Task SeedForUser(long userId)
    {
        ...
        var taskPriorities = await dbContext.Set<TaskPriority>()
        ...
        var defaultTodoList = await dbContext.Set<TodoList>()
        ...
        if (defaultTodoList == null)
        {
            ...
            await dbContext.Set<TodoList>().AddAsync(defaultTodoList);
        ...
        var lastOrderToday = await dbContext.Set<TodoListItem>()
        ...
        var lastOrderThisWeek = await dbContext.Set<TodoListItem>()
        ...
        var lastOrderThisMonth = await dbContext.Set<TodoListItem>()
        ...
        await dbContext.Set<TodoListItem>().AddRangeAsync(todoLists);
        await dbContext.SaveChangesAsync();
